...
**Maps to:** R33, R86
**Files touched:** `lib/server/challenge/orders.ts` (new), `worker/challenge/process-order.ts` (new), `db/migrations/0011_order_lifecycle.sql` (new), `lib/server/challenge/ledger.ts` (authorized numeric-order fix), `tests/helpers/postgres.ts` (modify), `tests/challenge/order-lifecycle.test.ts` (new), `tests/challenge/ledger-replay.test.ts` (authorized only when the SQL gate requires fixture updates), `missions/public-market-commentary/debug-t16-decision-alias.md` (authorized debug artifact), `missions/public-market-commentary/debug-t16-observation-decimal.md` (authorized debug artifact), `missions/public-market-commentary/debug-t16-close-sequence.md` (authorized debug artifact), `missions/public-market-commentary/debug-t16-exit-fee-join.md` (authorized debug artifact), `missions/public-market-commentary/debug-t16-short-financing-notional.md` (authorized debug artifact), `missions/public-market-commentary/debug-t16-ledger-risk-fixture.md` (authorized debug artifact), `missions/public-market-commentary/debug-t16-completed-retry-source-policy.md` (authorized debug artifact), `missions/public-market-commentary/debug-t16-risk-recompute-sql.md` (authorized debug artifact), `missions/public-market-commentary/debug-t16-completed-job-result-required.md` (authorized debug artifact), `missions/public-market-commentary/debug-t16-full-suite-cleanup.md` (authorized debug artifact), `missions/public-market-commentary/debug-t16-result-json-types.md` (authorized debug artifact)
